...
import static dashboard_admin.Header_admin.admin_petugas;
 ...
 * @author AIS
 */
public class Main_login_petugas extends javax.swing.JFrame {

    Connection con=Connect_sql.getConnection();
    ResultSet rs = null;
    PreparedStatement ps = null;
    public Main_login_petugas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_idpetugas, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 90, 140, -1));
    ...
    private void bt_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_loginActionPerformed
        ...
        String sql = "SELECT * FROM db_petugas WHERE idPetugas='"+txt_idpetugas.getText()+"' and password='"+password.getText()+"'";
        try {
            ps = con.prepareStatement(sql);
            rs=ps.executeQuery();
            if(rs.next()){
                admin_petugas.setText(rs.getString(2));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_login_petugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
