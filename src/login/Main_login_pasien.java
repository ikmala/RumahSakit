...
import static dashboard_pasien.Header_pasien.admin_pasien;
import dashboard_pasien.Main_pasien;
import static dashboard_pasien.setting_pasien.agama;
import static dashboard_pasien.setting_pasien.alamat;
import static dashboard_pasien.setting_pasien.berat;
import static dashboard_pasien.setting_pasien.bpjs;
import static dashboard_pasien.setting_pasien.email;
import static dashboard_pasien.setting_pasien.gol_darah;
import static dashboard_pasien.setting_pasien.nama;
import static dashboard_pasien.setting_pasien.nik;
import static dashboard_pasien.setting_pasien.password_pasien;
import static dashboard_pasien.setting_pasien.pekerjaan;
import static dashboard_pasien.setting_pasien.pendidikan;
import static dashboard_pasien.setting_pasien.telphon;
import static dashboard_pasien.setting_pasien.tinggi;
import static dashboard_pasien.setting_pasien.bt_laki11;
import static dashboard_pasien.setting_pasien.bt_perempuan11;
import static dashboard_pasien.setting_pasien.buttonGroup222;
...
import static dashboard_pasien.setting_pasien.tgl_lahir1111;

/**
 *
 * @author AIS
 */
public class Main_login_pasien extends javax.swing.JFrame {

    Connection con=Connect_sql.getConnection();
    ResultSet rs = null;
    PreparedStatement ps = null;
    public Main_login_pasien() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_nik, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 90, 140, -1));
    ...
    private void ilustrasiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ilustrasiMouseClicked
        new Main_signin_pasien().setVisible(true);
        this.dispose();
    }//GEN-LAST:event_ilustrasiMouseClicked

    private void bt_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_loginActionPerformed

        String sql = "SELECT * FROM db_pasien WHERE nik='"+txt_nik.getText()+"' and password='"+password.getText()+"'";
        try {
            ps = con.prepareStatement(sql);
            rs=ps.executeQuery();
            if(rs.next()){
                admin_pasien.setText(rs.getString("nama"));

                nik.setText(rs.getString("nik"));
                nama.setText(rs.getString("nama"));
                email.setText(rs.getString("email"));
                password_pasien.setText(rs.getString("password"));
                alamat.setText(rs.getString("alamat"));
                String jk = rs.getString("jk");
                if(jk == null ){
                    buttonGroup222.clearSelection();
                }else
                if(jk.equals("Laki Laki")){
                    bt_laki11.setSelected(true);
                }else if(jk.equals("Perempuan")){
                    bt_perempuan11.setSelected(true);
                }
                telphon.setText(rs.getString("telphon"));
                bpjs.setText(rs.getString("bpjs"));
                gol_darah.setText(rs.getString("gol_darah"));
                agama.setText(rs.getString("agama"));
                pekerjaan.setText(rs.getString("pekerjaan"));
                pendidikan.setText(rs.getString("pendidikan"));
                tinggi.setText(rs.getString("tinggi"));
                berat.setText(rs.getString("berat"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_login_pasien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
