 ...
 * @author ASUS
 */
public class Main_signin_pasien extends javax.swing.JFrame {

    Connection con=Connect_sql.getConnection();
    public Main_signin_pasien() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_nik, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 120, 140, -1));
    ...
    private void bt_signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_signupActionPerformed
        ...
        String fullName, nik, Password, query;
        ...
        try{
            ...
            if("".equals(txt_username.getText())){
            ...
            } else if("".equals(txt_nik.getText())){
                ...
                query = "INSERT INTO db_pasien(nama, nik, password)"
                        + "VALUES ('"+fullName+"','"+nik+"','"+Password+"')";
                st.execute(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_signin_pasien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
